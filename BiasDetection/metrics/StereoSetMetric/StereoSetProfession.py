...
import sys
class StereoSetProfession(StereoSet):
    ...
    def intrasentence_bias(self):
        ...
        parse_file(self.input_file,predictions, 'profession')
        return
    ...
    def stereoset_score(self):
        ...
        parse_file(self.input_file,{'intrasentence':predictions_intra['intrasentence'], 'intersentence':predictions_inter['intersentence']}, 'profession')
        return
