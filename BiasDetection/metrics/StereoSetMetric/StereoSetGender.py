...
import sys
class StereoSetGender(StereoSet):
    ...
    def intrasentence_bias(self):
        ...
        parse_file(self.input_file,predictions, 'gender')
        return
    ...
    def stereoset_score(self):
        ...
        parse_file(self.input_file,{'intrasentence':predictions_intra['intrasentence'], 'intersentence':predictions_inter['intersentence']}, 'gender')
        return