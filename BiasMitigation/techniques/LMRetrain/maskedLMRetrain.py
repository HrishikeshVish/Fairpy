...
def Retrain(model_name_or_path, train_file, counterfactual_augmentation,output_dir, do_train=True, seed=4, preprocessing_num_workers=4,max_seq_length=512,save_steps=500, max_steps=1000, per_device_train_batch_size=32,gradient_accumulation_steps=16,dropout_debias=False):
...
def _mp_fn(index):
    # For xla_spawn (TPUs)
    Retrain(output_dir='/output/', train_file='C:/Users/hrish/Documents/Purdue/Summer 22/Language Bias/Bias Detection/bias-bench-main/data/text/wikipedia-2.5.txt', counterfactual_augmentation='race')


if __name__ == "__main__":
    Retrain(model_name_or_path = 'bert-base-uncased',output_dir='/output/', train_file='C:/Users/hrish/Documents/Purdue/Summer 22/Language Bias/Bias Detection/bias-bench-main/data/text/wikipedia-2.5.txt', counterfactual_augmentation='race')
